...
class TravauxRepository {
  ...
  static Future<List<Travaux>> fetchTravauxByAddress(String address) async {
    final response = await http.get(Uri.parse(
        'https://data.angers.fr/api/explore/v2.1/catalog/datasets/info-travaux/records?where=address%20LIKE%20%22$address%25%22&limit=100'));
